...
# operating system:  Linux 2.4.19-k7 i686 [ELF] (2.4.19)
# libc:	(6.2.5)
# binutils:	(213)
...
VENDORMANVERSION = `echo 4 2 1 | sed 's/ /./g'`
...
CDEBUGFLAGS = -g -Wall -pedantic -ansi -fstrict-prototype
...
COPYRIGHTDATE = 1991-2002
    COPYRIGHT = Copyright © $(COPYRIGHTDATE) by $(AUTHORS)
      ...
      VERSION =   $(VERSION_MAJOR).$(VERSION_MINOR).$(VERSION_PATCHLEVEL)$(VERSION_STATUS)
...
all:: README.txt
README.txt: $(MSUB) README.txt.msub
	$(RM) README.txt
	$(MSUB) $(MSUBFLAGS) README.txt.msub >README.txt
...
all:: README.txt
          ...
          SUBDIRS = doc contrib src
  MAKEFILESUBDIRS = doc contrib src lib
     CLEANSUBDIRS = doc contrib src lib
       DEPSUBDIRS =     contrib src
   INSTALLSUBDIRS =             src lib
  INCLUDESSUBDIRS =             src
INSTALLMANSUBDIRS = doc
       TAGSUBDIRS =             src
